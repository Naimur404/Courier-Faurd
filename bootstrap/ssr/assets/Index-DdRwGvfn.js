...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 py-12 sm:py-16"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="text-center mb-16"><div class="inline-flex items-center justify-center p-2 bg-blue-100 rounded-full mb-6"><i class="fas fa-crown text-blue-600 text-2xl"></i></div><h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6"> Choose Your <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Plan</span></h1><p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed"> Select the perfect plan for your business needs. All plans include our comprehensive courier tracking API with real-time updates and 24/7 support. </p></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-16"><!--[-->`);
      ssrRenderList(__props.plans, (plan, index) => {
        _push(ssrRenderComponent(_sfc_main$1, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (index === 1) {
                _push2(`<div class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-center py-3"${_scopeId}><span class="text-sm font-semibold"${_scopeId}><i class="fas fa-star mr-1"${_scopeId}></i>Most Popular </span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="p-8"${_scopeId}><div class="text-center"${_scopeId}><div class="${ssrRenderClass(["inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r rounded-xl mb-6", getPlanIconGradient(index)])}"${_scopeId}><i class="${ssrRenderClass(["fas text-white text-2xl", getPlanIcon(index)])}"${_scopeId}></i></div><h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2"${_scopeId}>${ssrInterpolate(plan.name)}</h3><p class="text-gray-600 dark:text-gray-300 mb-6"${_scopeId}>${ssrInterpolate(plan.description)}</p><div class="mb-8"${_scopeId}><span class="text-5xl font-bold text-gray-900 dark:text-white"${_scopeId}>${ssrInterpolate(plan.formatted_price)}</span><span class="text-gray-500 text-lg"${_scopeId}>/ ${ssrInterpolate(plan.duration_text)}</span></div></div><ul class="space-y-4 mb-8"${_scopeId}><!--[-->`);
              ssrRenderList(plan.features, (feature) => {
                _push2(`<li class="flex items-start"${_scopeId}><div class="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5"${_scopeId}><i class="fas fa-check text-green-600 text-sm"${_scopeId}></i></div><span class="text-gray-700 dark:text-gray-300 leading-relaxed"${_scopeId}>${ssrInterpolate(feature)}</span></li>`);
              });
              _push2(`<!--]--></ul><div class="pt-4"${_scopeId}>`);
              if (user.value) {
                _push2(`<!--[-->`);
                if (hasActiveSubscription.value) {
                  _push2(`<button disabled class="w-full bg-gray-100 text-gray-500 py-4 px-6 rounded-xl font-semibold cursor-not-allowed border border-gray-200"${_scopeId}><i class="fas fa-check-circle mr-2"${_scopeId}></i>Already Subscribed </button>`);
                } else {
                  _push2(ssrRenderComponent(unref(link_default), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<i class="fas fa-arrow-right mr-2"${_scopeId2}></i>Subscribe Now `);
                      } else {
                        return [
                ...
                _push2(ssrRenderComponent(unref(link_default), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<i class="fas fa-rocket mr-2"${_scopeId2}></i>Get Started `);
                    } else {
                      return [
      ...
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_sfc_main$1, { class: "p-8 sm:p-12 max-w-6xl mx-auto mb-16" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center mb-12"${_scopeId}><div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-xl mb-4"${_scopeId}><i class="fas fa-credit-card text-white text-2xl"${_scopeId}></i></div><h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4"${_scopeId}>Payment Information</h2><p class="text-gray-600 dark:text-gray-300"${_scopeId}>Simple and secure payment process with instant activation</p></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12"${_scopeId}><div${_scopeId}><h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center"${_scopeId}><div class="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center mr-3"${_scopeId}><i class="fas fa-mobile-alt text-pink-600"${_scopeId}></i></div> Bkash Payment </h3><div class="bg-gradient-to-r from-pink-50 to-rose-50 border-2 border-pink-200 rounded-xl p-6"${_scopeId}><div class="text-center"${_scopeId}><p class="text-gray-700 mb-3 font-medium"${_scopeId}>Send money to:</p><div class="bg-white rounded-lg p-4 mb-4 shadow-sm"${_scopeId}><p class="text-3xl font-bold text-pink-600 mb-2"${_scopeId}>01309092748</p><button class="text-sm text-pink-600 hover:text-pink-700 font-medium"${_scopeId}><i class="fas fa-copy mr-1"${_scopeId}></i>Copy Number </button></div><div class="bg-pink-100 rounded-lg p-4"${_scopeId}><p class="text-sm text-pink-800 font-medium"${_scopeId}><i class="fas fa-info-circle mr-2"${_scopeId}></i> Send money and provide the transaction ID during subscription. </p></div></div></div></div><div${_scopeId}><h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center"${_scopeId}><div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3"${_scopeId}><i class="fas fa-clock text-blue-600"${_scopeId}></i></div> Process Timeline </h3><div class="space-y-4"${_scopeId}><div class="flex items-start"${_scopeId}><div class="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4"${_scopeId}> 1 </div><div class="pt-1"${_scopeId}><p class="text-gray-900 dark:text-white font-medium"${_scopeId}>Choose Plan &amp; Payment</p><p class="text-gray-600 dark:text-gray-300 text-sm"${_scopeId}>Select your plan and complete Bkash payment</p></div></div><div class="flex items-start"${_scopeId}><div class="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4"${_scopeId}> 2 </div><div class="pt-1"${_scopeId}><p class="text-gray-900 dark:text-white font-medium"${_scopeId}>Submit Transaction ID</p><p class="text-gray-600 dark:text-gray-300 text-sm"${_scopeId}>Provide your Bkash transaction ID</p></div></div><div class="flex items-start"${_scopeId}><div class="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4"${_scopeId}> 3 </div><div class="pt-1"${_scopeId}><p class="text-gray-900 dark:text-white font-medium"${_scopeId}>Payment Verification</p><p class="text-gray-600 dark:text-gray-300 text-sm"${_scopeId}>We verify within 2-24 hours</p></div></div><div class="flex items-start"${_scopeId}><div class="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4"${_scopeId}><i class="fas fa-check text-sm"${_scopeId}></i></div><div class="pt-1"${_scopeId}><p class="text-gray-900 dark:text-white font-medium"${_scopeId}>Subscription Active</p><p class="text-gray-600 dark:text-gray-300 text-sm"${_scopeId}>Start using API immediately</p></div></div></div></div></div>`);
          } else {
            return [
      ...
      _push(`<div class="max-w-6xl mx-auto"><div class="text-center mb-12"><div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl mb-4"><i class="fas fa-question-circle text-white text-2xl"></i></div><h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Frequently Asked Questions</h2><p class="text-gray-600 dark:text-gray-300">Everything you need to know about our plans and services</p></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-8"><!--[-->`);
      ssrRenderList(faqs, (faq) => {
        _push(ssrRenderComponent(_sfc_main$1, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex items-start"${_scopeId}><div class="${ssrRenderClass(["flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center mr-4", `bg-${faq.iconColor}-100`])}"${_scopeId}><i class="${ssrRenderClass(["fas", `fa-${faq.icon}`, `text-${faq.iconColor}-600`])}"${_scopeId}></i></div><div${_scopeId}><h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3"${_scopeId}>${ssrInterpolate(faq.title)}</h3><p class="text-gray-600 dark:text-gray-300 leading-relaxed"${_scopeId}>${ssrInterpolate(faq.answer)}</p></div></div>`);
            } else {
              return [
                createVNode("div", { class: "flex items-start" }, [
                  createVNode("div", {

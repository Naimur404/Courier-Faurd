...
<template>
  ...
  <AppLayout>
    ...
    <!-- Subscription Plans -->
    <section class="py-10 md:py-20 bg-slate-50 dark:bg-slate-900">
      <div class="container mx-auto px-4">
        <div class="text-center mb-8 md:mb-14">
          ...
          <h2 class="text-2xl md:text-4xl font-bold text-slate-900 dark:text-white mt-2 mb-3 md:mb-4">
            আপনার প্রয়োজন অনুযায়ী প্ল্যান বেছে নিন
          </h2>
          <p class="text-sm md:text-base text-slate-600 dark:text-slate-400 max-w-xl mx-auto">
    ...
    <!-- Features Section -->
    <section class="py-10 md:py-20 bg-white dark:bg-slate-800/50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-8 md:mb-14">
        ...
        <div class="grid md:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <h3 class="text-lg md:text-xl font-bold text-slate-900 dark:text-white mb-2 md:mb-3">{{ feature.title }}</h3>
            <p class="text-sm text-slate-600 dark:text-slate-400">{{ feature.desc }}</p>
          </div>
        </div>
      </div>
    </section>

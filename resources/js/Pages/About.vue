...
<template>
    <Head>
        ...
        <meta name="description" content="FraudShield - বাংলাদেশী কুরিয়ার ফ্রড ডিটেকশন সিস্টেম। আমাদের মিশন ও সেবা সম্পর্কে জানুন।" />
        ...
        <!-- OpenGraph Meta Tags -->
        <meta property="og:title" content="About Us - FraudShield | আমাদের সম্পর্কে" />
        <meta property="og:description" content="বাংলাদেশী কুরিয়ার ফ্রড ডিটেকশন সিস্টেম সম্পর্কে জানুন।" />
        ...
        <meta name="twitter:title" content="About Us - FraudShield | আমাদের সম্পর্কে" />
        <meta name="twitter:description" content="বাংলাদেশী কুরিয়ার ফ্রড ডিটেকশন সিস্টেম সম্পর্কে জানুন।" />

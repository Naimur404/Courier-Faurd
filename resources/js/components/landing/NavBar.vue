                ...
                <div class="container mx-auto px-4 py-4">
                    ...
                    <div class="space-y-1 mb-4">
                        <button
                            ...
                            :key="link.name"
                            @click="scrollToSection(link.href)"
                            class="flex items-center gap-3 w-full px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
                        >
                            <component :is="link.icon" class="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                            {{ link.name }}
                        </button>
                    </div>
